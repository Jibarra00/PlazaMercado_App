...
namespace Presentation
{
    public partial class WFProducto : System.Web.UI.Page
    {
        ...
        protected void BTnSave_Click(object sender, EventArgs e)
        {
            ...
            if (executed)
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                 "swal('Exitoso', 'Se guardo el producto exitosamente', 'success')", true);
            ...
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                "swal('Error', 'Error al guardar el producto', 'error')", true);
        ...
        protected void BTnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                 "swal('Exitoso', 'Se actualizo el producto exitosamente', 'success')", true);
                //LblMsg.Text = "Se ha guardado el comentario exitosamente!";
                clear();
            }
            else
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                "swal('Error', 'Error al actualizar el producto', 'error')", true);
                //LblMsg.Text = "Error al guardar";
            }
        }
